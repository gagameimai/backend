...
@section('unit.dealer', 'active')

@section('content')
    <x-components::unit-title guard="admin" area="dealer" />
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-6">
                                        <div class="form-group">
                                            <label>*聯絡電話</label>
                                            <input type="text" class="form-control" v-model="createData.tel" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group">
                                            <label>*縣市</label>
                                            <select class="form-control" v-model="createData.county" required>
                                                <option value="">請選擇</option>
                                                @foreach ($county as $index => $row)
                                    ...
                                    <div class="col-12 col-sm-8">
                                        <div class="form-group">
                                            <label>*地址</label>
                                            <input type="text" class="form-control" v-model="createData.address" required>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-6">
                                        <div class="form-group">
                                            <label>*聯絡電話</label>
                                            <input type="text" class="form-control" v-model="editData.tel" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group">
                                            <label>*縣市</label>
                                            <select class="form-control" v-model="editData.county" required>
                                                <option value="">請選擇</option>
                                                @foreach ($county as $index => $row)
                                                    <option value="{{ $index }}">{{ $row }}</option>
                                                @endforeach
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <label>*縣市</label>
                                <select class="form-control" v-model="search.county" required>
                                    <option value="">請選擇</option>
                                    @foreach ($county as $index => $row)
                                        <option value="{{ $index }}">{{ $row }}</option>
                                    @endforeach
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <tr v-for="(item, num) in items" :key="item.id">
                                        <td>@{{ item.name }}</td>
                                        <td>@{{ item.county | countyMapping}}</td>
...
@section('javascript')
    <script type="text/javascript">
        var vm = new Vue({
            ...
            filters: {
                countyMapping: function(index) {
                    return countyMap[index];
                }
            }
        });
    </script>
