...
@section('unit.car_fitting', 'active')

@section('content')
    <x-components::unit-title guard="admin" area="product" unit="car_fitting" />
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label>*材質</label>
                                            <input class="form-control" v-model="createData.material"/>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label>*電源</label>
                                            <input class="form-control" v-model="createData.power"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label>*材質</label>
                                            <input class="form-control" v-model="editData.material"/>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label>*電源</label>
                                            <input class="form-control" v-model="editData.power"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
