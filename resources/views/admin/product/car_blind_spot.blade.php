...
@section('content')
    <x-components::unit-title guard="admin" area="product" unit="car_blind_spot" />
                                ...
                                <tbody>
                                    <tr v-for="(item, num) in items" :key="item.id">
                                        ...
                                        <td class="method-button">
                                            <button class="btn btn-warning btn-sm" @click="open('spc', item.id)">
...
@section('javascript')
    ...
    <script type="text/javascript">
        var vm = new Vue({
            el: '#container',
            data: {
                url: '{{ route('admin.car_blind_spot') }}',
                items: {},
                createData: {},
                editData: {},
                search: {
            ...
            methods: {
                ...
                open: function(active = '', id = '') {
                    ...
                    switch (active) {
                        ...
                        case 'spc':
                            location.href = '{{ route('admin.car_blind_spot_format') }}' + '/' + id;
                            break;
                ...
                doFormButton: function(action) {
                    vm.button = action == 'show' ? true : false;
                },
                createItem: function() {
                    try {
                ...
                checkboxAll: function() {
                    if (vm.is_checked == false) {
                        vm.formats.forEach((item, index) => {
                            vm.item.car_fit.push(item.id)
                        });
                    } else {
                        vm.item.car_fit = [];
                    }
