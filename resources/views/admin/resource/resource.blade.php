                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12 col-sm-6">
                                        <div class="form-group">
                                            <label>*分類</label>
                                            <select class="form-control" v-model="createData.resource_category_id" required>
                                                <option value="">請選擇</option>
                                                <option v-for="row in categorys" :value="row.id">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label>*外部連結</label>
                                            <input type="url" class="form-control" v-model="createData.url" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12 col-sm-6">
                                        <div class="form-group">
                                            <label>*分類</label>
                                            <select class="form-control" v-model="editData.resource_category_id" required>
                                                <option v-for="row in categorys" :value="row.id">
                                                    @{{ row.name }} @{{ row.status == 0 ? '(停用)' : '' }}
                                                </option>
                                            </select>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label>*外部連結</label>
                                            <input type="url" class="form-control" v-model="editData.url" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <select class="form-control" v-model="search.resource_category_id">
                                    <option value="">請選擇</option>
                                    <option v-for="row in categorys" :value="row.id">
                                        @{{ row.name }} @{{ row.status == 0 ? '(停用)' : '' }}
                                    </option>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <tr v-for="(item, num) in items" :key="item.id">
                                        <td>
                                            @{{ item.category ? item.category.name + (item.category.status == 0 ? '(停用)' : '') : '' }}
                                        </td>
                                        <td>@{{ item.name }}</td>
                                        <td>
                    ...
                    try {
                        axios.get(vm.url + '/all', {
                            params: {
                                page: page,
                                name: vm.search.name,
                                resource_category_id: vm.search.resource_category_id,
                            }
